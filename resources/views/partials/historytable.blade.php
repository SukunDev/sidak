                                    ...
                                    <tr
                                        ...
                                        <td class="text-sm text-gray-500 px-6 py-4 whitespace-nowrap capitalize">
                                                ...
                                                @if ($item->keberterimaan)
                                                    <div class="flex gap-1 justify-center text-xs">
                                                        <a class="px-1.5 py-1.5 rounded-md bg-blue-600 hover:bg-blue-500 active:bg-blue-600 transition duration-300 text-white"
                                                            href="/{{ $item->keberterimaan }}">
                                                            <svg class="w-3 fill-current"
                                                        ...
                                                        <a class="px-1.5 py-1.5 rounded-md bg-red-600 hover:bg-red-500 active:bg-red-600 transition duration-300 text-white"
                                                            href="/{{ Request::path() }}/hapus-keberterimaan/{{ $item->id }}">
                                                            <svg class="w-3 fill-current"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512">
                                                                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                                ...
                                                @else
                                                    <div class="flex gap-1 justify-center text-xs">
                                                        <button data-id="{{ $item->id }}"
                                                            data-kalibrator="{{ $item->kalibrator }}"
                                                            data-tempatkalibrasi="{{ $item->tempat_kalibrasi }}"
                                                            data-tanggal="{{ Carbon\Carbon::parse($item->jadwal_kalibrasi)->format('d, F Y') }}"
                                                            class="uploadkebersamaan px-1.5 py-1.5 rounded-md bg-slate-800 hover:bg-slate-700 active:bg-slate-800 transition duration-300 text-white">
                                                            <svg class="w-3 fill-current"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 512 512">
                                                                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            @else
                                                ...
                                                @else
                                                    <span class="text-right">Keberterimaan Belum Di Upload</span>
                                                @endif
                                            @endif
                                        </td>
                                        <td class="text-sm text-gray-500 px-6 py-4 whitespace-nowrap capitalize">
                                            ...
                                            @else
                                                ...
                                                @else
                                                    <span class="text-right">Sertifikat Belum Di Upload</span>
                                                @endif
                                            @endif
                                        </td>
                                    </tr>
