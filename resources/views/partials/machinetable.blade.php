                    ...
                    <form class="flex gap-4 items-center" method="GET">
                        ...
                        <div class="flex flex-col">
                            ...
                            <select onchange="this.form.submit()"
                                ...
                                <option value="di jadwalkan" @if (request('status') === 'di jadwalkan') selected @endif>
                                    di jadwalkan</option>
                                <option value="belum di jadwalkan" @if (request('status') === 'belum di jadwalkan') selected @endif>
                                    belum di jadwalkan</option>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 capitalize">
                                            <a class="hover:text-blue-400 transition duration-300"
                                                href="{{ '/' . (Request::is('admin*') ? 'admin/alat/' : 'dashboard/alat/') . 'detail/' . $item['id'] }}">{{ $item['nama_alat'] }}</a>
                                                ...
                                                <ul class="flex items-center gap-2 text-xs capitalize list-disc list-inside transition duration-300"
                                                    ...
                                                    <li>
                                                        <a class="-ml-2 hover:text-blue-400 transition duration-300"
                                                            href="{{ '/' . (Request::is('admin*') ? 'admin/alat/' : 'dashboard/alat/') . 'detail/' . $item['id'] }}">detail</a>
                                                    </li>
                                                    <li>
                                                        <a class="-ml-2 hover:text-blue-400 transition duration-300"
                                                            href="{{ '/' . (Request::is('admin*') ? 'admin/alat/' : 'dashboard/alat/') . 'edit/' . $item['id'] }}">edit</a>
                                                    </li>
                                                    <li>
