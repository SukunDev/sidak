@if (session()->has('info'))
    <div id="alert" class="fixed top-16 right-4 w-96 z-[100]">
        <div class="flex p-4 mb-4 bg-blue-100 rounded-lg">
            ...
            <div class="ml-3 text-sm font-medium text-blue-700">
                {{ session('info') }}, <b>{!! session('pesan') !!}</b>
            </div>
            <button type="button"
...
@if (session()->has('success'))
    <div id="alert" class="fixed top-16 right-4 w-96 z-[100]">
        <div class="flex p-4 mb-4 bg-green-100 rounded-lg">
            ...
            <div class="ml-3 text-sm font-medium text-green-700">
                {{ session('success') }}, <b>{!! session('pesan') !!}</b>
            </div>
            <button type="button"
    ...
    <div id="alert" class="fixed top-16 right-4 w-96 z-[100]">
        <div class="flex p-4 mb-4 bg-red-100 rounded-lg">
            ...
            <div class="ml-3 text-sm font-medium text-red-700">
                {{ session('danger') }}, <b>{!! session('pesan') !!}</b>
            </div>
            <button type="button"
...
@if (session()->has('warning'))
    <div id="alert" class="fixed top-16 right-4 w-96 z-[100]">
        <div class="flex p-4 mb-4 bg-yellow-100 rounded-lg">
            ...
            <div class="ml-3 text-sm font-medium text-yellow-700">
                {{ session('warning') }}, <b>{!! session('pesan') !!}</b>
            </div>
            <button type="button"
