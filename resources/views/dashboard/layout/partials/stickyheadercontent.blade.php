        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                <button id="notification-button"
                    ...
                    @if ($user->notifications->where('has_been_view', '=', 0)->count() > 0)
                ...
                @component('dashboard.layout.partials.notificationpanel', ['user' => $user])
                @endcomponent
                ...
                <div id="searchPanel" class="fixed top-[100px] md:top-[60px] inset-x-4 md:right-auto md:left-[17rem]"
                    ...
                    <div class="w-full md:w-[26rem] rounded-md bg-white shadow-md border border-gray-200">
                        ...
                        <ul>
                            <li class="hidden">
                                <a class="flex gap-2 px-4 py-2 rounded-md hover:bg-gray-100 font-medium text-gray-600 hover:font-normal hover:text-gray-700"
